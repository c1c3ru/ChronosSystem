    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900">
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          <Card
            variant="glass"
            className="group hover:scale-105 transition-all duration-300 animate-slide-up delay-1"
          >
            <CardContent className="p-8 text-center">
          ...
          <Card
            variant="glass"
            className="group hover:scale-105 transition-all duration-300 animate-slide-up delay-2"
          >
            <CardContent className="p-8 text-center">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div
                key={index}
                className={`flex items-center space-x-3 animate-slide-up delay-${index + 1}`}
              >
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-20">
          ...
          >
            ...
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Painel Administrativo</h3>
          ...
          >
            ...
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Portal do Estagiário</h3>
              <p className="text-neutral-400 text-sm mb-6 leading-relaxed">
          ...
          >
            ...
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Kiosk</h3>
              <p className="text-neutral-400 text-sm mb-6 leading-relaxed">
              ...
              <Button
                asChild
                variant="ghost"
                className="w-full group border border-warning/30 hover:bg-warning/10"
              >
                <Link href="/kiosk">
                  Abrir Kiosk
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />

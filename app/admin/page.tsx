                        ...
                        <div className="flex items-center">
                          {intern.lastStatus ? (
                            intern.lastStatus.type === 'ENTRY' ? (
                              ...
                              <span className="flex items-center gap-1.5 bg-neutral-800 text-neutral-400 px-2.5 py-0.5 rounded-full font-medium">
                                <span className="h-1.5 w-1.5 rounded-full bg-neutral-500" />
                                Saiu às {new Date(intern.lastStatus.timestamp).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}
                              </span>
                            )
                          ) : (

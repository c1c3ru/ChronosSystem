            ...
            <div className="container mx-auto px-6 py-8">
                            ...
                            {nextHoliday ? (
                                <div>
                                    ...
                                    <div className="mt-4 flex items-center text-sm text-neutral-400">
                                        ...
                                        <span>
                                            {nextHoliday.type === 'fixed' ? 'Data fixa' : 'Data móvel'}
                                        </span>
                                    </div>
                                </div>
                            ) : (
                    ...
                    <Card className="md:col-span-2">
                        ...
                        <CardContent>
                            <div className="space-y-2 text-neutral-300">
                                <p>O sistema bloqueia automaticamente registros de ponto em feriados nacionais e finais de semana.</p>
                                <p>Para permitir trabalho nestes dias, é necessário criar uma justificativa do tipo <strong>EXTRA_WORK</strong> previamente aprovada.</p>
                                <div className="flex flex-wrap gap-2 mt-4">
                                    ...
                                    <span className="px-2 py-1 bg-neutral-700 rounded text-xs">Municipal (Fortaleza)</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {data?.holidays.map((holiday, index) => {
                        ...
                        return (
                            <Card key={index} className={`${isToday ? 'border-primary ring-1 ring-primary' : isPast ? 'opacity-60' : ''}`}>
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-neutral-500 capitalize mt-1">{holiday.dayOfWeek}</p>
                                        </div>
                                        <div className="flex flex-col items-end">
                                            {holiday.name.includes('Ceará') && (
                                                <span className="text-xs bg-blue-900/50 text-blue-200 px-2 py-1 rounded mb-1">Estadual</span>
                                            )}
                                            {holiday.name.includes('Fortaleza') && (
                                                <span className="text-xs bg-green-900/50 text-green-200 px-2 py-1 rounded mb-1">Municipal</span>
                                            )}
                                        </div>
                                    </div>
                                </CardContent>

            ...
            <div className="max-w-[210mm] mx-auto mb-4 px-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
                    ...
                    <p className="text-blue-800">
                        Esta é uma demonstração do novo layout dos formulários oficiais do IFCE.
                        O formulário agora possui bordas visíveis nos campos, estilo de documento impresso,
                        e segue fielmente o padrão oficial.
                    </p>
                </div>
            </div>

...
import { maskCNPJ, maskCPF, maskPhone } from '@/lib/input-masks'
...
export default function ProfessionalActivitiesPage() {
  ...
  const handleGeneratePDF = async () => {
    try {
      ...
      const { buildProfessionalActivitiesDoc } =
        await import('@/lib/pdf-templates/professional-activities.pdf')
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <CardTitle className="text-2xl uppercase">
                  Declaração de Atividades Profissionais
                </CardTitle>
            ...
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    name="employee_ctps_number"
                    className="input w-full"
                    value={formData.employee_ctps_number || ''}
                    onChange={handleInputChange}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="input w-full"
                    value={formData.employee_ctps_series || ''}
                    onChange={handleInputChange}
                    placeholder="Série"
                    title="Série"
                  />

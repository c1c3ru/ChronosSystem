            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-2xl">
                  Ficha de Avaliação do Discente Estagiário
                </CardTitle>
          ...
          <Card variant="elevated">
            <CardHeader>
              ...
              <div className="text-xs text-neutral-500 mt-2">
                <strong>1</strong> - Insuficiente | <strong>2</strong> - Regular |{' '}
                <strong>3</strong> - Bom | <strong>4</strong> - Muito Bom | <strong>5</strong> -
                Excelente
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Descreva observações adicionais sobre o desempenho do estagiário"
                ></textarea>
              </div>
              <div>
                <label className="block text-sm font-medium text-neutral-300 mb-2">
                  Recomendaria este estagiário para futuras oportunidades?
                </label>

      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <form ref={formRef} className="space-y-6">
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">1. Instituição Concedente</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input
                  ...
                  value={formData.company_fantasy_name}
                  onChange={handleInputChange}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <input
                  ...
                  value={formData.company_city_state}
                  onChange={handleInputChange}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input
                  ...
                  value={formData.company_representative_role}
                  onChange={handleInputChange}
                  placeholder="Cargo"
                  className="input w-full"
                  title="Cargo do Representante"
                />
                <input
                  name="company_representative_cpf"
                  value={formData.company_representative_cpf}
                  onChange={handleInputChange}
                  placeholder="CPF"
                  className="input w-full"
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">2. Discente Estagiário(a)</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input
                  ...
                  placeholder="Bairro"
                  className="input w-full"
                  title="Bairro do Aluno"
                />
                <input
                  name="student_city_state"
                  value={formData.student_city_state}
                  onChange={handleInputChange}
                  placeholder="Município-UF"
                  className="input w-full"
                  title="Município-UF do Aluno"
                />
                <input
                  name="student_zip"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <input
                  ...
                  value={formData.student_email_institutional}
                  onChange={handleInputChange}
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">3. Detalhes do Estágio</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Nº Apólice de Seguro"
                  className="input w-full"
                  title="Nº Apólice de Seguro"
                />
                <input
                ...
                <div>
                  <label className="flex items-center gap-2 mb-2 text-sm text-neutral-300">
                    <input
                      type="checkbox"
                      name="has_grant"
                      checked={formData.has_grant === 'true'}
                      onChange={handleInputChange}
                      title="Possui Bolsa Auxílio?"
                    />
                ...
                <div>
                  <label className="flex items-center gap-2 mb-2 text-sm text-neutral-300">
                    <input
                      type="checkbox"
                      name="has_transport"
                      checked={formData.has_transport === 'true'}
                      onChange={handleInputChange}
                      title="Possui Auxílio Transporte?"
                    />
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">4. Orientação e Supervisão</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                <h4 className="text-sm font-semibold text-neutral-300 mb-2">
                  Docente Orientador (IFCE)
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    name="advisor_name"
                  ...
                  <input
                    name="advisor_siape"
                    value={formData.advisor_siape}
                    onChange={handleInputChange}
                    placeholder="SIAPE"
                    className="input w-full"
                    title="SIAPE do Orientador"
                  />
                  <input
                    name="advisor_phone"
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  />
                  <input
                    name="supervisor_education"
                    value={formData.supervisor_education}
                    onChange={handleInputChange}
                    placeholder="Formação/Experiência"
                    className="input w-full"
                    title="Formação do Supervisor"
                  />
                  <input
                    name="supervisor_cpf"
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">5. Plano de Atividades</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <textarea
                ...
                onChange={handleInputChange}
                rows={5}
                placeholder="Atividades a serem desenvolvidas (liste uma por linha)"
                className="input w-full"
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={5}
                placeholder="Resultados esperados (liste um por linha)"
                className="input w-full"

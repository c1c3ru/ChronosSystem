...
export default function FinalReportPage() {
  return (
    <div className="bg-gray-50 p-8 min-h-screen">
      ...
      <div className="max-w-4xl mx-auto bg-white p-8 shadow shadow-gray-300">
        <h1 className="text-2xl font-bold text-center mb-8">RELATÓRIO FINAL DE ESTÁGIO OBRIGATÓRIO</h1>

...
export default function InternshipRegistrationRequestPage() {
  ...
  const handleTurnoChange = (
    turno: 'primeira' | 'segunda' | 'terceira',
    dia: string,
    value: string
  ) => {
    setFormData((prev) => ({
  ...
  const handleGeneratePDF = async () => {
    try {
      ...
      const doc = await buildInternshipRegistrationRequestDoc({
        ...
        supervisor_telefone: formData.supervisor_telefone,
    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 p-4 sm:p-8">
      <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-neutral-400 text-sm mt-1">
                  IFCE Campus Maracanaú - Modelo Oficial
                </p>
              </div>
            </div>
          </CardHeader>
        ...
        <form ref={formRef} className="space-y-6">
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">2. Cor/Raça e Etnia</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">3. Informações do Estágio</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">Deficiências (Se houver)</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">4. Unidade Concedente / Empresa</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  name="nome_fantasia_pf"
                  value={formData.nome_fantasia_pf}
                  onChange={handleInputChange}
                ...
                />
                <input
                  name="cnpj_registro_conselho"
                  value={formData.cnpj_registro_conselho}
                  onChange={handleInputChange}
                  placeholder="CNPJ ou Registro no Conselho"
                  className="input"
                  title="CNPJ ou Registro"
                />
              </div>
              <input
                name="endereco_pf"
                value={formData.endereco_pf}
                onChange={handleInputChange}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <input
                  ...
                  placeholder="Bairro"
                  className="input"
                  title="Bairro da Empresa"
                />
                <input
                  name="municipio_uf_pf"
                  value={formData.municipio_uf_pf}
                  onChange={handleInputChange}
                  placeholder="Município-UF"
                  className="input"
                  title="Município-UF da Empresa"
                />
                <input
                  name="cep_pf"
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">5. Responsável Legal e Supervisor</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4 border-t border-neutral-800 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  />
                  <input
                    name="setor_realizacao"
                    value={formData.setor_realizacao}
                    onChange={handleInputChange}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <input
                    ...
                    value={formData.supervisor_telefone}
                    onChange={handleInputChange}
                    placeholder="DDD + Telefone do Supervisor"
                    className="input"
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="text-lg">6. Horários e Escolaridade</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4 border-b border-neutral-800 pb-6">
                <h3 className="text-sm font-semibold text-neutral-400">
                  Jornada de Atividade (Horários de Início e Fim)
                </h3>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...
                            horarios: {
                              ...prev.horarios,
                              [dia]: { ...prev.horarios[dia], final: e.target.value },
                            },
                          }))
                        }
                        placeholder="Fim"
              ...
              <div className="space-y-4 border-b border-neutral-800 pb-6">
                <h3 className="text-sm font-semibold text-neutral-400">
                  Escolaridade (Informar o Estágio do Turno das Aulas)
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...
                        turnos: {
                          ...prev.turnos,
                          primeira: { ...prev.turnos.primeira, segunda: e.target.value },
                        },
                      }))
                    }
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...
                        turnos: {
                          ...prev.turnos,
                          segunda: { ...prev.turnos.segunda, segunda: e.target.value },
                        },
                      }))
                    }
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...
                        turnos: {
                          ...prev.turnos,
                          terceira: { ...prev.turnos.terceira, segunda: e.target.value },
                        },
                      }))
                    }

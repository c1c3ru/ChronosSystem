      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-neutral-400">
            Teste a funcionalidade do scanner em dispositivos móveis
          </p>
        </div>
          ...
          <CardContent>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-semibold ${typeof window !== 'undefined' && window.location.protocol === 'https:' ? 'text-success' : 'text-error'}`}
                >
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-semibold ${typeof navigator !== 'undefined' && navigator.mediaDevices && typeof navigator.mediaDevices.getUserMedia === 'function' ? 'text-success' : 'text-error'}`}
                >
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <QRScanner onScan={handleScan} isActive={isScanning} onActivate={handleActivate} />
          </CardContent>
        </Card>
        ...
        <div className="mt-6 text-center">
          <Button asChild variant="secondary">
            <a href="/qr-diagnostic">🔧 Diagnóstico Completo</a>
          </Button>
        </div>
      </div>
    </div>

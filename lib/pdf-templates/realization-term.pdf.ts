...
export async function buildRealizationTermDoc(
  d: RealizationTermData
  ...
  const content: Content[] = [
    ...
    dataTable(
      ...
      [
        [
          {
            text: 'ATIVIDADES DESENVOLVIDAS NO ESTÁGIO',
            style: 'tableHeader',
    ...
    dataTable(
      ...
      [
        [
          {
            text: 'SOBRE O ACOMPANHAMENTO DO ESTÁGIO',
            style: 'tableHeader',
            alignment: 'center' as Alignment,
            colSpan: 2,
          },
        ...
        [
          {
            stack: [
              {
                text: 'A AVALIAÇÃO DE DESEMPENHO DO DISCENTE ESTAGIÁRIO FOI REALIZADA ATRAVÉS DE',
                fontSize: 7,
                bold: true,
                alignment: 'center' as Alignment,
              },
              { text: '\n' },
              {
                text: `${cb(d.tracking_student?.meetings)} REUNIÃO(ÕES)`,
                fontSize: 8,
                margin: [10, 0, 0, 2],
              },
              {
                text: `${cb(d.tracking_student?.reports)} RELATÓRIO(S)`,
                fontSize: 8,
                margin: [10, 0, 0, 2],
              },
              {
                text: `${cb(d.tracking_student?.observation)} OBSERVAÇÃO(ÕES)`,
                fontSize: 8,
                margin: [10, 0, 0, 2],
              },
              {
                text: `${cb(d.tracking_student?.other)} OUTRO(S) MEIO(S) (CITAR ABAIXO)`,
                fontSize: 8,
                margin: [10, 0, 0, 2],
              },
              {
          ...
          },
          {
            stack: [
              {
                text: 'A COMUNICAÇÃO ENTRE O SUPERVISOR E O DOCENTE ORIENTADOR FOI REALIZADA ATRAVÉS DE',
                fontSize: 7,
                bold: true,
                alignment: 'center' as Alignment,
              },
              { text: '\n' },
              {
                text: `${cb(d.tracking_supervisor_advisor?.meetings)} REUNIÃO(ÕES)`,
                fontSize: 8,
                margin: [10, 0, 0, 2],
              },
              {
                text: `${cb(d.tracking_supervisor_advisor?.phone)} TELEFONE`,
                fontSize: 8,
                margin: [10, 0, 0, 2],
              },
              {
                text: `${cb(d.tracking_supervisor_advisor?.visit)} VISITA(S)`,
                fontSize: 8,
                margin: [10, 0, 0, 2],
              },
              {
                text: `${cb(d.tracking_supervisor_advisor?.other)} OUTRO(S) MEIO(S) (CITAR ABAIXO)`,
                fontSize: 8,
                margin: [10, 0, 0, 2],
              },
              {
        ...
        [
          {
            ...
            columns: [
              ...
              {
                text: `${cb(d.overall_evaluation === 'insuficiente')} INSUFICIENTE`,
                fontSize: 8,
                margin: [0, 4, 10, 0],
              },
              {
                text: `${cb(d.overall_evaluation === 'regular')} REGULAR`,
                fontSize: 8,
                margin: [0, 4, 10, 0],
              },
              {
                text: `${cb(d.overall_evaluation === 'bom')} BOM`,
                fontSize: 8,
                margin: [0, 4, 10, 0],
              },
              {
                text: `${cb(d.overall_evaluation === 'otimo')} ÓTIMO`,
                fontSize: 8,
                margin: [0, 4, 10, 0],
              },
            ],
    ...
    dataTable(
      ...
      [
        [
          {
            text: 'AVALIAÇÃO DO DISCENTE ESTAGIÁRIO',
            style: 'tableHeader',
            alignment: 'center' as Alignment,
            colSpan: 2,
          },
        ...
        [
          {
            stack: [
              {
                text: 'ATRIBUIR VALORES PARA AS CARACTERÍSTICAS DO DISCENTE ESTAGIÁRIO, DE ACORDO COM OS CONCEITOS:',
                fontSize: 7,
                bold: true,
                alignment: 'center' as Alignment,
              },
              {
                text: '( 1 ) INSUFICIENTE   ( 2 ) REGULAR   ( 3 ) BOM   ( 4 ) ÓTIMO',
                fontSize: 7,
                alignment: 'center' as Alignment,
                margin: [0, 2, 0, 2],
              },
    ...
    dataTable(
      ...
      [
        [
          {
            text: 'SUGESTÕES PARA O IFCE MELHORAR A QUALIFICAÇÃO PROFISSIONAL DE SEUS ALUNOS',
            style: 'tableHeader',
            alignment: 'center' as Alignment,
          },
        ],
          ...
          [
            ...
            },
            {
              stack: [
                ...
                {
                  text: fmtDate(d.supervisor_date) || '___/___/___',
                  fontSize: 8,
                  alignment: 'center' as Alignment,
                  margin: [0, 5, 0, 0],
                },
          ...
          [
            ...
            },
            {
              stack: [
                ...
                {
                  text: fmtDate(d.student_aware_date) || '___/___/___',
                  fontSize: 8,
                  alignment: 'center' as Alignment,
                  margin: [0, 5, 0, 0],
                },

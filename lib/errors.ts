      ...
      [
        {
          ...
          action: 'retry',
          description: 'Revisar e corrigir os dados do formulário',
        },
      ],
      'low'
    )
...
export class ConflictError extends AppError {
  constructor(message = 'Conflito de dados', details?: unknown) {
    super(
      ...
      [
        {
          label: 'Usar dados diferentes',
          action: 'retry',
          description: 'Tentar com dados diferentes',
        },
        {
          label: 'Ver registros existentes',
          action: 'view',
          description: 'Ver registros existentes',
        },
      ],
      'medium'
    )
      ...
      [
        {
          ...
          action: 'retry',
          description: 'Aguardar alguns minutos antes de tentar novamente',
        },
      ],
      'medium'
    )
    ...
    super(
      ...
      [
        { label: 'Tentar novamente', action: 'retry', description: 'Tentar a operação novamente' },
        {
          ...
          action: 'report',
          description: 'Reportar este problema ao suporte',
        },
      ],
      'high'
    )
...
export class BusinessError extends AppError {
  constructor(
    ...
    super(message, 400, code, details, userMessage || message, details, recoveryActions, 'medium')
  }
}
...
export class QRCodeError extends AppError {
  constructor(
    ...
    super(message, 400, code, details, userMessage || message, details, recoveryActions, 'low')
  }
}
...
export class QRInvalidError extends QRCodeError {
  constructor(message = 'QR Code inválido') {
    super(message, 'QR_INVALID', undefined, 'Este QR Code é inválido ou não foi reconhecido.', [

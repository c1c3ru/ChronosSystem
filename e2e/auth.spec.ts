...
test.describe('Authentication Flow', () => {
  ...
  test('should navigate to admin login when clicking admin card', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('should navigate to employee portal when clicking employee card', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('should show sign-in page when accessing protected route', async ({
    page,
  }: {
    page: Page
  }) => {

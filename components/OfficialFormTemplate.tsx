        ...
        <div className="mb-4 border-b border-black pb-2">
            ...
            <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex-1 text-center">
                    ...
                    <div className="text-[9px] uppercase leading-tight mt-0.5">
...
export function OfficialFormTemplate({
    ...
    return (
        <div
            id={formId}
            className="bg-white shadow-lg mx-auto official-form-container"
        >
            <OfficialHeader
                title={title}
                subtitle={subtitle}
...
export function FormTable({ children, className = '' }: { children: ReactNode, className?: string }) {
    return (
        <table
            className={`w-full official-form-table text-[9pt] mb-2 ${className}`}
        >
            {children}
        </table>
    )
...
export function FormField({ label, children, colSpan, className = '' }: FormFieldProps) {
    return (
        <td
            className={`official-form-field px-1 py-0.5 align-top ${className}`}
            colSpan={colSpan}
        >
            <label className="block text-[7pt] font-bold text-black mb-0.5 uppercase">
                {label}
            </label>
    ...
    return (
        <div className={`mt-4 ${className}`}>
            ...
            <div className="border-t border-black pt-1 mt-10">
                <div className="text-center font-bold text-[8pt] uppercase">
                    {label}
                </div>
            </div>
        </div>

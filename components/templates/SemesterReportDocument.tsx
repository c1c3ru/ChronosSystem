...
export const SemesterReportDocument = forwardRef<HTMLDivElement, SemesterReportDocumentProps>(({ data }, ref) => {
    ...
    return (
        <div ref={ref} className="bg-white text-black font-sans box-border mx-auto" style={{ width: '210mm', padding: '10mm' }}>
            ...
            <h1 className="text-center font-bold text-[12pt] mb-8 uppercase">RELATÓRIO SEMESTRAL DE ATIVIDADES</h1>
                ...
                <tbody>
                    <tr>
                        ...
                        <td className="border border-black p-2 align-top w-1/4">
                            ...
                            <div className="text-[9pt] mt-1">{data.hours_semester} HORAS</div>
                        </td>
                        <td className="border border-black p-2 align-top w-1/4">
            ...
            <div className="border border-black p-4 text-[9pt] whitespace-pre-wrap min-h-[80px] mb-4 text-justify">
                {data.comments}
            </div>

...
describe('attendance-logic', () => {
  ...
  describe('analyzeDayForJustification', () => {
    ...
    it('deve detectar falta completa', () => {
      const result = analyzeDayForJustification(date, null, null, workingHours, true)
    ...
    it('deve detectar atraso significativo', () => {
      ...
      const result = analyzeDayForJustification(date, entryRecord, exitRecord, workingHours, true)
    ...
    it('deve detectar registro incompleto (sem saída)', () => {
      ...
      const result = analyzeDayForJustification(yesterday, entryRecord, null, workingHours, true)

...
files.forEach(file => {
    ...
    content = content.replace(/borderBottom:\s*1\s*,/g, "borderBottomWidth: 1, borderBottomStyle: 'solid',");
    ...
    content = content.replace(/borderRight:\s*1\s*,/g, "borderRightWidth: 1, borderRightStyle: 'solid',");
